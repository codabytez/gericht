...
const PhotoGallery = () => {
  return (
    <section className="relative">
      <div className="flex flex-col lg:flex-row gap-16 justify-center items-center  py-10 xl:pl-20 overflow-x-hidden max-w-[2000px] m-auto">
        <div
        ...
        <div className="flex flex-col gap-6 lg:max-w-[491px] px-5">
          ...
          <div className="w-max m-auto xl:m-0">
